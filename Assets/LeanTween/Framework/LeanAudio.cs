...
public class LeanAudioOptions : object {
	...
	/**
	* Set the frequency for the audio is encoded. 44100 is CD quality, but you can usually get away with much lower (or use a lower healAndDamageAmount to get a more 8-bit sound).
	* 
	* @method setFrequency

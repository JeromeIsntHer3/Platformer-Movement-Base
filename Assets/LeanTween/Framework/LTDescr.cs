...
public class LTDescr
{
	...
	public LTDescr setRotateAround(){
		...
		this.easeInternal = ()=>{
            ...
            trans.localPosition = origPos - diff; // Subtract the healAndDamageAmount the object has been shifted over by the rotate, to get it back to it's orginal position
	...
	public LTDescr setCanvasRotateAround(){
		...
		this.easeInternal = ()=>{
			...
			rect.localPosition = origPos - diff; // Subtract the healAndDamageAmount the object has been shifted over by the rotate, to get it back to it's orginal position
